...
declare function CalenderMonth({ currentDay, eventsData, updateEvent, calendarType, startingWeekday, showAddNewEventButton, monthViewDayTitleFormat, calendarHeight, minimumEventHeight, calendarHeader, calendarToAddOrUpdateEvent, monthViewMinCellHeight: boxHeight, onNextClick: _onNextClick, onPrevClick: _onPrevClick, onDateChange: _onDateChange, calendarViewOptions, onCalendarTypeChange, }: CalenderMonthProps): JSX.Element;
