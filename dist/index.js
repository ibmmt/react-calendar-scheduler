...
function TimeInput({ onChange, value }) {
    ...
    const [formattedValue, setFormattedValue] = React.useState(formatTime(new Date()));
    ...
    return (jsxRuntime.jsxs("div", Object.assign({ className: "time-input-wrapper" }, { children: [jsxRuntime.jsx("input", { type: "text", value: inputValue, placeholder: formattedValue, className: "ib__sc-form-control", onChange: handleInputChange, onFocus: () => setShowDropdown(true), onBlur: () => {
                    handleInputBlur();
                    setTimeout(() => setShowDropdown(false), 200);
                }, ref: inputRef }), showDropdown && (jsxRuntime.jsx("div", Object.assign({ className: "dropdown-time", ref: dropdownRef }, { children: dropdownValues.map((value, index) => (jsxRuntime.jsx("div", Object.assign({ className: index === activeIndex ? 'active' : '', onClick: () => {
                        setInputValue(value);
...
const AddEventModal = (_a) => {
    ...
    const [startDate, setStartDate] = React.useState(startDateInit ? startDateInit : dateString);
    const [endDate, setEndDate] = React.useState(endDateInit ? endDateInit : dateString);
    const [startTime, setStartTime] = React.useState(startTimeInit);
    const [endTime, setEndTime] = React.useState(endTimeInit);
    const [bg_color, setBg_color] = React.useState(bg_colorInit);
    ...
    return (jsxRuntime.jsx("div", Object.assign({ className: "modal-wrapper ib__sc-modal", onClick: e => {
            ...
            opacity: show ? '1' : '0',
        } }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc-modal-content ib__sc_add_event_box" }, { children: [jsxRuntime.jsxs("div", Object.assign({ className: "modal-header" }, { children: [!sc_app__id ? jsxRuntime.jsx("p", { children: "Add Event" }) : jsxRuntime.jsx("p", { children: "Edit Event" }), jsxRuntime.jsx("span", Object.assign({ className: "ib__sc__close-modal-btn", onClick: handleClose }, { children: "\u00D7" }))] })), jsxRuntime.jsx("div", Object.assign({ className: "ib__sc-modal-body" }, { children: jsxRuntime.jsxs("form", Object.assign({ noValidate: true }, { children: [jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__form-group" }, { children: [jsxRuntime.jsx("label", Object.assign({ className: "ib__sc-label", htmlFor: "title" }, { children: "Title" })), jsxRuntime.jsx("input", { type: "text", placeholder: "Title", value: title, className: "ib__sc-form-control", onChange: e => setTitle(e.target.value), required: true })] })), jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__form-time-row" }, { children: [jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__form-group" }, { children: [jsxRuntime.jsx("label", Object.assign({ className: "ib__sc-label", htmlFor: "startDate" }, { children: "Start Date" })), jsxRuntime.jsx("input", { type: "date", placeholder: "yyyy-mm-dd", className: "ib__sc-form-control", value: startDate, onChange: e => setStartDate(e.target.value), required: true }), jsxRuntime.jsx("label", Object.assign({ className: "ib__sc-label", htmlFor: "startTime" }, { children: "Start Time" })), jsxRuntime.jsx(TimeInput, { value: startTime, onChange: (value) => setStartTime(value) })] })), jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__form-group" }, { children: [jsxRuntime.jsx("label", Object.assign({ className: "ib__sc-label", htmlFor: "endDate" }, { children: "End Date" })), jsxRuntime.jsx("input", { type: "date", placeholder: "yyyy-mm-dd", className: "ib__sc-form-control", value: endDate, onChange: e => setEndDate(e.target.value), required: true }), jsxRuntime.jsx("label", Object.assign({ className: "ib__sc-label", htmlFor: "endTime" }, { children: "End Time" })), jsxRuntime.jsx(TimeInput, { value: endTime, onChange: (value) => setEndTime(value) })] }))] })), jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__form-group" }, { children: [jsxRuntime.jsx("label", Object.assign({ className: "ib__sc-label", htmlFor: "bg_color" }, { children: "Description" })), jsxRuntime.jsx("input", { type: "color", value: bg_color, className: "ib__sc-form-control", onChange: e => setBg_color(e.target.value), required: true })] })), jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__form-group" }, { children: [jsxRuntime.jsx("label", Object.assign({ className: "ib__sc-label", htmlFor: "bg_color" }, { children: "Decription" })), jsxRuntime.jsx("textarea", { value: description, className: "ib__sc-form-control", onChange: e => setDescription(e.target.value), required: true })] })), jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__modal_footer" }, { children: [jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__btn", onClick: handleSubmit }, { children: !sc_app__id ? jsxRuntime.jsx(jsxRuntime.Fragment, { children: "Save" }) : jsxRuntime.jsx(jsxRuntime.Fragment, { children: "Update " }) })), sc_app__id && (jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__btn", onClick: e => {
                                            e.preventDefault();
                                        }, onDoubleClick: handleDeleteEvent }, { children: "Delete" })))] }))] })) }))] })) })));
};

function CalendarSwitch({ calenderType, handleClanderTypeChange, }) {
    return (jsxRuntime.jsx(React__default["default"].Fragment, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__btn-group ib__sc__calander_switch" }, { children: [jsxRuntime.jsx("button", Object.assign({ className: 'ib__sc__btn ib_sc_btn_month ' +
                        (calenderType === 'month' ? 'active' : ''), onClick: () => handleClanderTypeChange('month') }, { children: "Month" })), jsxRuntime.jsx("button", Object.assign({ className: 'ib__sc__btn ib_sc_btn_week ' +
                        (calenderType === 'week' ? 'active' : ''), onClick: () => handleClanderTypeChange('week') }, { children: "Week" })), jsxRuntime.jsx("button", Object.assign({ className: 'ib__sc__btn ib_sc_btn_day ' +
                        (calenderType === 'day' ? 'active' : ''), onClick: () => handleClanderTypeChange('day') }, { children: "Day" }))] })) }));
}

const HOUR_MILLISECONDS = 60 * 60 * 1000;

const EventHandlerContex = React.createContext();
...
const EventBoxView = ({ eventObj, isShowTitle, isStart, }) => {
    ...
    return (jsxRuntime.jsxs("div", Object.assign({ className: `ib__sc__event-box-view ${isStart ? 'ib__sc__staring_event_box' : ''} ${(_a = eventObj.custom_class) !== null && _a !== void 0 ? _a : ''}`, style: viewStyle }, { children: [isShowTitle && (jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__event ib__sc__event-week_title" }, { children: eventObj.title }))), isShowTitle && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__event-element" }, { children: eventObj.element && eventObj.element })), jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__event-description" }, { children: eventObj.description && eventObj.description }))] }))] })));
};
...
const EventBoxWeek = ({ boxHeight, boxTime = 1, eventObj, boxDay, dragingEventId, }) => {
    ...
    const [overLap, setOverLap] = React.useState({ top: false, bottom: false });
    const newEventTime = React.useRef({ start: 0, end: 0 });
    const { updateEvent, dragStart, dragEnd, calenderToAddOrUpdateEvent } = React.useContext(EventHandlerContex);
    const eventRef = React.useRef(null);
    const lastCleintYRef = React.useRef(0);
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: eventObj && (jsxRuntime.jsx("div", Object.assign({ id: eventObj.sc_app__id, className: 'ib__sc__event-wrapper ib__sc__event-wrapper-week ' +
            ...
            }, style: eventStyle }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__event-box ib__sc__event-box-week", style: {
                    height: eventHeight + 'px',
                    backgroundColor: eventObj.bg_color,
                } }, { children: [overLap && !overLap.top && (jsxRuntime.jsx("div", Object.assign({ style: isResizing ? { display: 'block' } : {}, className: "dragging-handler-week top", onMouseDown: e => {
                            handleMouseDownResize(e, 'top');
                        } }, { children: "=" }))), jsxRuntime.jsx(EventBoxView, { eventObj: eventObj, 
                        //eventHeight={eventHeight}
                        isShowTitle: true }), overLap && !overLap.bottom && (jsxRuntime.jsx("div", Object.assign({ style: isResizing ? { display: 'block' } : {}, className: "dragging-handler-week bottom", onMouseDown: e => {
...
const DayColumnWeek = ({ events, boxHeight, boxDay, dragBoxMouseEnterToCell, calenderToAddOrUpdateEvent, dragingEventId, }) => {
    ...
    */
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx("div", Object.assign({ ref: BoxRef, className: "ib__sc__cell ib__sc__cell-week" }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__cell-wrapper ib__sc__cell-wrapper-week" }, { children: [!!events &&
                        !!events.length &&
                        events.map(eventObj => (jsxRuntime.jsx(EventBoxWeek, { eventObj: eventObj, boxDay: boxDay, 
                            // calenderTableRef={calenderTableRef}
                            boxHeight: boxHeight, dragingEventId: dragingEventId }, eventObj.sc_app__id))), isSameDay(boxDay, new Date()) && (jsxRuntime.jsx(CurrentTimeBar, { boxHeight: boxHeight })), [...Array(24).keys()].map((hour, index) => (jsxRuntime.jsx("div", { onClick: e => handleClickHourBox(e, hour), style: { height: boxHeight + 'px' }, draggable: true, className: "ib__sc__table-hr-box-week" }, index)))] })) })) }));
};
const CurrentTimeBar = ({ boxHeight }) => {
    ...
    return (jsxRuntime.jsx("div", { style: { top: top + 'px' }, className: "ib__sc__daybar-week" }));
};

const leftIconImg = '../assets/img/left-arrow.png';
const rightIconImg = '../assets/img/right-arrow.png';
const LeftIcon = () => jsxRuntime.jsx("img", { src: leftIconImg, alt: "lefticon" });
const RightIcon = () => jsxRuntime.jsx("img", { src: rightIconImg, alt: "righticon" });
...
const CalendarWeek = ({ eventsData, updateEvent, selectedDate, calenderType, weekHourBoxHeight = boxHeightInit, startingWeekday, weekCalenderDayStartFromHour, weekCalenderVisibleHour = 12, weekCalenderTitleFormate = 'ddd', weekCalenderTimeFormate = 24, noOfDayColumn, calenderHeight, isShowAddNewEventButton, weekCalenderNextBtnDayIncrement, handleNextClick: _handleNextClick, handlePrevClick: _handlePrevClick, handleChangeCurrentDate: _handleChangeCurrentDate, calenderToAddOrUpdateEvent, handleIncreaseTimeSpan: _handleIncreaseTimeSpan, handleClanderTypeChange, }) => {
    ...
    const calenderTableRef = React.useRef(null);
    const lastCleintYRef = React.useRef(0);
    const dragEventRef = React.useRef(null);
    const currentDragDate = React.useRef(null);
    ...
    const [dateStartFrom, setDateStartFrom] = React.useState(initSelectedDate);
    React.useEffect(() => {
    ...
    return (jsxRuntime.jsx("div", { children: jsxRuntime.jsxs("div", Object.assign({ className: 'ib__sc__table ib__sc__table-week ib_sc_type_' + calenderType }, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__header_wrapper" }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__header" }, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__header__date-switch" }, { children: jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__week-date" }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__week-date-btn-group" }, { children: [jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__week-date__bt-prev ib__sc__np__btn", onClick: () => onWeekChange(-1) }, { children: jsxRuntime.jsx(LeftIcon, {}) })), jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__week-date__bt-text" }, { children: jsxRuntime.jsx("input", { type: "date", className: "ib__sc-form-control", onChange: (e) => {
                                                        setDateStartFrom(new Date(e.target.value));
                                                    }, value: formatDate(dateStartFrom, 'yyyy-MM-dd') }) })), jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__week-date__bt-next ib__sc__np__btn", onClick: () => onWeekChange(1) }, { children: jsxRuntime.jsx(RightIcon, {}) }))] })) })) })), jsxRuntime.jsx("div", { className: "ib__sc__header__center" }), jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__header__right" }, { children: [isShowAddNewEventButton && jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__header__right__btn-group" }, { children: jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__btn", onClick: () => { if (calenderToAddOrUpdateEvent)
                                                calenderToAddOrUpdateEvent({}); } }, { children: "Add Event" })) })), jsxRuntime.jsx(CalendarSwitch, { calenderType: calenderType, handleClanderTypeChange: (type) => { if (handleClanderTypeChange)
                                            handleClanderTypeChange(type); } })] }))] })) })), jsxRuntime.jsx("div", Object.assign({ style: { position: 'relative', display: 'flex' } }, { children: jsxRuntime.jsx(EventHandlerContex.Provider, Object.assign({ value: {
                            dragStart,
                            updateEvent: updateEvent,
                            dragEnd: dropHandler,
                            calenderToAddOrUpdateEvent: calenderToAddOrUpdateEvent,
                        } }, { children: jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__table-out ib__sc__table-out-week", style: {
                                maxHeight: calenderHeight,
                                overflowY: heightOfWeekColumn > calenderHeight ? 'scroll' : 'initial',
                            }, ref: calenderTableRef }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__tb-wrapper ib__sc__tb-wrapper-week" }, { children: [jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__tb_week_time", style: { minHeight: heightOfWeekColumn + 'px' } }, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__table-th" }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__btn-group ib__sc__increment-timespan ib__sc__flex_center" }, { children: [jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__btn", onClick: () => _handleIncreaseTimeSpan(-1) }, { children: "-" })), jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__btn", onClick: () => {
                                                                _handleIncreaseTimeSpan(1);
                                                            } }, { children: "+" }))] })) })), jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__cell ib__sc__cell-week" }, { children: [...Array(24).keys()].map((hour, index) => (jsxRuntime.jsx("div", Object.assign({ style: { height: boxHeight + 'px' }, className: " ib__sc__week-time", draggable: "true" }, { children: index !== 0 && (jsxRuntime.jsx("span", Object.assign({ className: "ib__sc__time_title" }, { children: timeFormateFromHour(hour, weekCalenderTimeFormate) }))) }), index))) }))] })), [...Array(noOfDayColumn).keys()].map((dayIndex) => {
                                        const now = new Date(dateStartFrom);
                                        const boxDay = new Date(now.setDate(now.getDate() + dayIndex)).setHours(0, 0, 0, 0);
                                        return (jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__table-td ib__sc__table-td-week", style: { minHeight: heightOfWeekColumn + 'px' } }, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__table-th ib__sc__truncate" }, { children: formatDate(new Date(boxDay), weekCalenderTitleFormate) }), dayIndex), jsxRuntime.jsx(DayColumnWeek, { calenderTableRef: calenderTableRef, boxHeight: boxHeight, updateEvent: updateEvent, 
                                                    // dragingEventId={
...
const EventBoxMonth = ({ boxHeight, boxTime, eventObj, boxDay, isCalender, isDraging, isResizing, }) => {
    const [offset, setOffset] = React.useState(0);
    const [eventHeight, setEventHeight] = React.useState(0);
    const [overLap, setOverLap] = React.useState({ start: false, end: false });
    const newEventTime = React.useRef({ start: 0, end: 0 });
    const mouseDownRef = React.useRef(false);
    const { dragStart, dragEnd, resizeStart, resizeEnd, calenderToAddOrUpdateEvent, } = React.useContext(EventHandlerContex);
    const eventRef = React.useRef(null);
    /**
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: eventObj && (jsxRuntime.jsx("div", Object.assign({ id: eventObj.sc_app__id + '', className: 'ib__sc__event-wrapper ib__sc__event-wrapper-month ' +
                (isDraging ? 'dragging' : '') +
                ' ' +
            ...
            style: eventStyle }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__event-box ib__sc__event-box-month", style: eventBoxStyle }, { children: [overLap && !overLap.start && (jsxRuntime.jsx("div", Object.assign({ style: isResizing ? { display: 'flex' } : {}, className: "dragging-handler-month left", onMouseDown: e => {
                            handleMouseDownResize(e, 'left');
                        } }, { children: "||" }))), jsxRuntime.jsx(EventBoxView, { eventObj: eventObj, 
                        // eventHeight={eventHeight}
                        ///  overLap={overLap}
                        // isCalender={isCalender}
                        isShowTitle: !overLap.start, isStart: !overLap.start }), overLap && !overLap.end && (jsxRuntime.jsx("div", Object.assign({ style: isResizing ? { display: 'flex' } : {}, className: "dragging-handler-month right", onMouseDown: e => {
...
function DayCellMonth({ currentBoxHeight, eventsInDay, boxHeight, boxDay, day, dragingEventId, resizingEventId, calenderToAddOrUpdateEvent, dragBoxMouseEnterToCell, }) {
    ...
    return (jsxRuntime.jsx("td", Object.assign({ ref: BoxRef, className: " ib__sc__table-td ib__sc__table-td-month", onClick: handleClickBox }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc_month_cell", style: { minHeight: `${currentBoxHeight + 20}px` } }, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ib__sc_month_cell_wrapper" }, { children: jsxRuntime.jsx("span", Object.assign({ className: "ib__sc_month_day" }, { children: day })) })), jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__table-td__day_cell", style: { minHeight: `${currentBoxHeight}px` } }, { children: eventsInDay.map((event, key) => (jsxRuntime.jsx(EventBoxMonth, { eventObj: event, boxHeight: boxHeight, boxTime: 1, boxDay: boxDay, isDraging: dragingEventId === event.sc_app__id, isResizing: resizingEventId === event.sc_app__id, isCalender: true }, key))) }))] })) })));
}
...
//fromDate = new Date(),
handleClanderTypeChange, }) {
    const [selectedDate, setSelectedDate] = React.useState(currentDay);
    const month = selectedDate.getMonth();
    const year = selectedDate.getFullYear();
    const yearMonth = `${year}-${(month + 1).toString().padStart(2, '0')}`;
    const firstDayOfMonth = new Date(year, month, 1).getDay();
    const daysInMonth = new Date(year, month + 1, 0).getDate();
    const [events, setEvents] = React.useState(calculatePositions(eventsData, true));
    const currentDragDate = React.useRef();
    const editingEventRef = React.useRef();
    const [isDraging, setIsDraging] = React.useState(false);
    const sideUseRef = React.useRef('');
    if (!boxHeight) {
        if (calenderHeight) {
    ...
    const renderDaysOfWeek = () => {
        return (jsxRuntime.jsx("tr", { children: weekdaysArr.map((day, index) => (jsxRuntime.jsx("th", Object.assign({ className: "ib__sc__table-th" }, { children: weekdaysArr[(index + startingWeekday) % 7] }), day))) }));
    };
    /**
    ...
    const renderCalendarDays = () => {
        ...
        for (let i = 0; i < Math.abs(firstDayOfMonth + 7 - startingWeekday) % 7; i++) {
            cells.push(jsxRuntime.jsx("td", Object.assign({ className: "ib__sc__table-td ib__sc__table-td-month " }, { children: jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__table-td__day_cell" }, { children: " " })) }), `empty-${i}`));
        }
        for (let i = 1; i <= daysInMonth; i++) {
            ...
            cells.push(jsxRuntime.jsx(DayCellMonth, { 
                // isDraging={isDraging}
            ...
            if (cells.length === 7) {
                rows.push(jsxRuntime.jsx("tr", Object.assign({ className: "ib__sc__table-td ib__sc__table-td-month" }, { children: cells }), i));
                cells = [];
            }
        }
        if (cells.length > 0) {
            for (let i = cells.length; i < 7; i++) {
                cells.push(jsxRuntime.jsx("td", {}, `empty-${i}`));
            }
            rows.push(jsxRuntime.jsx("tr", { children: cells }, daysInMonth));
        }
        return rows;
    };
    /**
    ...
    return (jsxRuntime.jsx("div", { children: jsxRuntime.jsx(EventHandlerContex.Provider, Object.assign({ value: {
                dragStart,
            ...
            } }, { children: jsxRuntime.jsxs("div", Object.assign({ className: 'ib__sc__table ib__sc__table-month-wrap ib_sc_type_' + calenderType }, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__header_wrapper" }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__header" }, { children: [jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__header__date-switch" }, { children: jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__month-date" }, { children: jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__month-date-btn-group" }, { children: [jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__month-date__bt-prev ib__sc__np__btn", onClick: () => onmonthChangeNextPrev(-1) }, { children: jsxRuntime.jsx(LeftIcon, {}) })), jsxRuntime.jsx("span", Object.assign({ className: "ib__sc__month-date__bt-text" }, { children: jsxRuntime.jsx("input", { type: "month", className: "ib__sc-form-control", placeholder: "yyyy-mm", onChange: selectMonth, value: yearMonth }) })), jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__month-date__bt-next ib__sc__np__btn", onClick: () => onmonthChangeNextPrev(1) }, { children: jsxRuntime.jsx(RightIcon, {}) }))] })) })) })), jsxRuntime.jsx("div", { className: "ib__sc__header__center" }), jsxRuntime.jsxs("div", Object.assign({ className: "ib__sc__header__right" }, { children: [isShowAddNewEventButton && jsxRuntime.jsx("div", Object.assign({ className: "ib__sc__header__right__btn-group" }, { children: jsxRuntime.jsx("button", Object.assign({ className: "ib__sc__btn", onClick: () => { calenderToAddOrUpdateEvent({}); } }, { children: "Add Event" })) })), jsxRuntime.jsx(CalendarSwitch, { calenderType: calenderType, handleClanderTypeChange: handleClanderTypeChange })] }))] })) })), jsxRuntime.jsx("div", { style: { position: 'relative', display: 'flex' } }), jsxRuntime.jsx("div", Object.assign({ className: "calendar" }, { children: jsxRuntime.jsxs("table", Object.assign({ className: "ib__sc__table-month", border: 0, cellSpacing: "0", cellPadding: "0" }, { children: [jsxRuntime.jsx("thead", { children: renderDaysOfWeek() }), jsxRuntime.jsx("tbody", { children: renderCalendarDays() })] })) }))] })) })) }));
}
...
events, }) {
     ...
     * set event id for events
     */
    const [isShowAddEvent, setIsShowAddEvent] = React.useState(false);
    ...
    const [calenderType, setCalenderType] = React.useState(_calenderType);
    const [eventsState, setEventsState] = React.useState(setEventID(events));
    const [weekHourBoxHeight, setWeekHourBoxHeight] = React.useState(_weekHourBoxHeight);
    React__default["default"].useEffect(() => {
